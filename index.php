...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    <div id="logo" class="fl_left">
      <h1><a href="index.php">Flower Shop </div>
  </header>
</div>
 ...
 <div class="sectiontitle">
    ...
    <figure>
      <ul class="nospace group logos">
        <li class="one_quarter first"><img src="images/demo/Tq.png" alt=""></li>
        <li class="one_quarter"><img src="images/demo/flower12.png" alt=""></li>
        <li class="one_quarter"><img src="images/demo/Log in.png" alt=""></li>
        <li class="one_quarter"><img src="images/demo/Flower9.png" alt=""></li>
      </ul>
    </figure>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/F.png');">
  <article class="hoc container clear"> 
    ...
    <footer class="one_quarter"><a class="btn" href="pages/register.php">Register</a></footer>
  </article>
</div>
